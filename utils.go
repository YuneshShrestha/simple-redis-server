...
// nilBulkStringMsg returns a nil bulk string message
...
// getIntArg parses an integer argument from a string representation and 
// returns the result and skipped amount of bytes in the array
func getIntArg(startPosition int, arr []byte) (*GetIntArgResult, error) {
	...
	// Building out a string with concatenation creates a new string each time.
	// String builder is more efficient for incrementally building a string
